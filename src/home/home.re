  ...
  <div className="flex justify-center h-screen items-center font-mono bg-gray-800">
    ...
    <div className="text-sm pl-8">
        ...
        <div className="flex mb-2">
          <p className="text-gray-300 text-base p-1 rounded hover:bg-blue-500 cursor-pointer">{ReasonReact.string("Me")}</p>
          <a className="text-gray-300 text-base p-1 ml-4 rounded hover:bg-red-500 cursor-pointer" href="https://medium.com/@srikoushik" target="_blank">{ReasonReact.string("Blog")}</a>
        </div>
        <div className="flex">
          <a href="https://github.com/srikoushik" target="_blank" className="p-1 mr-4 fill-current text-gray-300 hover:text-black cursor-pointer">
          ...
          <a href="http://linkedin.com/in/srikoushik/" target="_blank" className="p-1 mr-4 fill-current text-gray-300 hover:text-blue-700 cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
          ...
          <a href="https://www.instagram.com/koushiksri/" target="_blank" className="p-1 fill-current text-gray-300 hover:text-pink-500 cursor-pointer">
